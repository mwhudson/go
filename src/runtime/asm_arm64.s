...
TEXT runtime·asminit(SB),NOSPLIT,$0-0
	// not sure if this is required on arm64
        //MRS     fpsr, R17
	//BIC	$(1<<24), R17
        //MSR     R17, fpsr
	RET
...
TEXT runtime·gosave(SB),NOSPLIT,$-4-4
	...
	MOV	$0, R11
	MOV	R17, gobuf_lr(R0)
	MOV	R17, gobuf_ret(R0)
	MOV	R17, gobuf_ctxt(R0)
	RET
...
TEXT runtime·gogo(SB),NOSPLIT,$-4-4
	...
	MOV	gobuf_sp(R1), SP	// restore SP
	MOV	gobuf_lr(R1), LR
	MOV	gobuf_ret(R1), R0
	MOV	gobuf_ctxt(R1), R7
	MOV	$0, R
	MOV	R11, gobuf_sp(R1)	// clear to help garbage collector
	MOV	R11, gobuf_ret(R1)
	MOV	R11, gobuf_lr(R1)
	MOV	R11, gobuf_ctxt(R1)
	MOV	gobuf_pc(R1), R11
...
TEXT runtime·mcall(SB),NOSPLIT,$-4-4
	...
	MOV	SP, (g_sched+gobuf_sp)(g)
	MOV	LR, (g_sched+gobuf_pc)(g)
	MOV	$0, R17
	MOV	R17, (g_sched+gobuf_lr)(g)
	...
	MOVB	runtime·iscgo(SB), R17
	CMP	$0, R17
	BL.NE	runtime·save_g(SB)
	MOV	fn+0(FP), R0
	MOV	(g_sched+gobuf_sp)(g), SP
	SUB	$16, SP
	MOV	R1, 8(SP)
	MOV	R0, R7
	MOV	0(R0), R0
...
TEXT runtime·systemstack(SB),NOSPLIT,$0-4
	MOV	fn+0(FP), R0	// R0 = fn
	MOV	g_m(g), R1	// R1 = m

	MOV	m_gsignal(R1), R2	// R2 = gsignal
	CMP	g, R2
	B.EQ	noswitch

	MOV	m_g0(R1), R2	// R2 = g0
	CMP	g, R2
	B.EQ	noswitch
	...
	MOV	$runtime·badsystemstack(SB), R0
	BL	(R0)

switch:
	// save our state in g->sched.  Pretend to
	// be systemstack_switch if the G stack is scanned.
	MOV	$runtime·systemstack_switch(SB), R3
	ADD	$8, R3, R3 // get past push {lr}
	MOV	R3, (g_sched+gobuf_pc)(g)
	MOV	SP, (g_sched+gobuf_sp)(g)
