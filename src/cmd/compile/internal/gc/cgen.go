...
func Igen(n *Node, a *Node, res *Node) {
	...
	case OCALLFUNC, OCALLMETH, OCALLINTER:
		...
		*a = Node{}
		...
		a.Reg = int16(Thearch.REGSP)
		a.Addable = true
		a.Xoffset = fp.Width + FixedStackSize()
		a.Type = n.Type
		return
...
func cgen_callret(n *Node, res *Node) {
	...
	nod.Xoffset = fp.Width + FixedStackSize()
	nod.Type = fp.Type
	Cgen_as(res, &nod)
}
...
func cgen_aret(n *Node, res *Node) {
	...
	nod1.Addable = true
	nod1.Xoffset = fp.Width + FixedStackSize()
	nod1.Type = fp.Type
