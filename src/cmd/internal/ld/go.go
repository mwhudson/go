...
func deadcode() {
	...
	if Flag_sharedpartial != 0 {
		...
		mark(Linkrlookup(Ctxt, "runtime.Futexwakeup", 0))
		mark(Linkrlookup(Ctxt, "runtime.BytesHash", 0))
		mark(Linkrlookup(Ctxt, "runtime.BytesHash", 0))
		mark(Linkrlookup(Ctxt, "runtime.StringHash", 0))
		mark(Linkrlookup(Ctxt, "runtime.BytesHash", 0))
		mark(Linkrlookup(Ctxt, "runtime.StringHash", 0))
		mark(Linkrlookup(Ctxt, "runtime.BytesHash", 0))
		mark(Linkrlookup(Ctxt, "runtime.Int32Hash", 0))
		mark(Linkrlookup(Ctxt, "runtime.Int64Hash", 0))
		mark(Linkrlookup(Ctxt, "runtime.EfaceHash", 0))
		mark(Linkrlookup(Ctxt, "runtime.IfaceHash", 0))
		mark(Linkrlookup(Ctxt, "runtime.StringHash", 0))
		mark(Linkrlookup(Ctxt, "runtime.HashLoad", 0))
		mark(Linkrlookup(Ctxt, "runtime.MemclrBytes", 0))
		mark(Linkrlookup(Ctxt, "runtime.MemclrBytes", 0))
		mark(Linkrlookup(Ctxt, "runtime.Open", 0))
		mark(Linkrlookup(Ctxt, "runtime.Read", 0))
		mark(Linkrlookup(Ctxt, "runtime.Write", 0))
		mark(Linkrlookup(Ctxt, "runtime.Close", 0))
		mark(Linkrlookup(Ctxt, "runtime.Fadd64", 0))
		mark(Linkrlookup(Ctxt, "runtime.Fsub64", 0))
		mark(Linkrlookup(Ctxt, "runtime.Entersyscall", 0))
		mark(Linkrlookup(Ctxt, "runtime.Exitsyscall", 0))
		mark(Linkrlookup(Ctxt, "runtime.F32to64", 0))
		mark(Linkrlookup(Ctxt, "runtime.F64to32", 0))
		mark(Linkrlookup(Ctxt, "runtime.F64toint", 0))
		mark(Linkrlookup(Ctxt, "runtime.Fcmp64", 0))
		mark(Linkrlookup(Ctxt, "runtime.Fdiv64", 0))
		mark(Linkrlookup(Ctxt, "runtime.Fintto64", 0))
		mark(Linkrlookup(Ctxt, "runtime.Fmul64", 0))
		mark(Linkrlookup(Ctxt, "runtime.Futexsleep", 0))
		mark(Linkrlookup(Ctxt, "runtime.Gostringnocopy", 0))
		mark(Linkrlookup(Ctxt, "runtime.Maxstring", 0))
