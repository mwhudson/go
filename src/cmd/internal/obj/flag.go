...
func (ctxt *Link) CheckBuildOptions() {
	CheckBuildOptions(ctxt.Headtype, ctxt.Thechar, ctxt.Buildmode, ctxt.Linkshared)
}

func CheckBuildOptions(headtype int, thechar int32, mode Buildmode, linkshared bool) {
	switch mode {
	case Buildmode_None:
		// fine
	case Buildmode_CShared:
