...
func Writeobjdirect(ctxt *Link, b *Biobuf) {
	...
	Bputc(b, uint8(((symtableIndex-symtableIndexIndex)>>0)&0xff))
	Bputc(b, uint8(((symtableIndex-symtableIndexIndex)>>8)&0xff))
	Bputc(b, uint8(((symtableIndex-symtableIndexIndex)>>16)&0xff))
